//generates random number based on the length of the array parameter
function randomNumberGenerator(array){
    return Math.floor(Math.random() * array.length);
}

//months saves in an array
const months = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];

//fortunes saved in an array
const fortunes = ["you will make a game winning goal", "you will get money from an unexpected place", "you will make tons of friends", "you will discover you are loved by many", "you will discover you are liked by many", "you will have a very special day", "you will learn a lot of new things", "you will grow to be rich", "you will be experience a large amount of successful", "all your dreams will come true", "you will gain more confidence", "you will meet someone special", "you will perform well on a test", "you will attend a special event",  "you will receive a phone call that will bring good news"];

//misfortunes saved in an array
